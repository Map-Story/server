...
public class PostController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "게시물 조회에 성공했습니다.", content = @Content(schema = @Schema(implementation = Post.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "이미지 정보 추출에 성공했습니다.", content = @Content(schema = @Schema(implementation = Post.class))),
